...
class TestContact(BaseTest):
    ...
    def test_01_contact_success(self):
        self.contact_details_page.fill_info_contact("sapir", "sapir3453@gmail.com","this is a valid enquiry text")
        expected_result = "Contact Us"
        actual_result = self.contact_details_page.get_pass_message()
        assert actual_result == expected_result

    def test_02_contact_failed(self):
        self.contact_details_page.fill_info_contact("", "sapir3173@gmail.com", "this is a valid enquiry text" )
    ...
    def test_03_contact_failed(self):
        self.contact_details_page.fill_info_contact("sapir", "sapir3173gmail.com", "this is a valid enquiry text" )
    ...
    def test_04_contact_failed(self):
       self.contact_details_page.fill_info_contact("sapir", "sapir3173@gmail.com", "n")
